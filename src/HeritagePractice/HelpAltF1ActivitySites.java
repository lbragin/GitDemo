...
public class HelpAltF1ActivitySites {
  ...
  public void testHelpAltF1Activities() throws Exception {
    ...
    driver.findElement(By.xpath("//*[@id='j1_3_anchor']")).click(); 
      driver.findElement(By.xpath("//*[@id='j1_3_anchor']")).sendKeys(Keys.ALT, Keys.F1);
